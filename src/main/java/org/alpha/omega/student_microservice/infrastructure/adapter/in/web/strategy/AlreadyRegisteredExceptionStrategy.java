...
@Component
public class AlreadyRegisteredExceptionStrategy implements HttpErrorResponseStrategy{

    @Override
    public Boolean support(Throwable ex) {
        return ex instanceof AlreadyRegisteredException;
    }
    ...
    public Mono<Void> handle(ServerWebExchange exchange, Throwable ex) {
        ...
        var body = String.format(WebMessages.Exceptions.ALREADY_REGISTERED_EXCEPTION_BODY, ex.getMessage());
